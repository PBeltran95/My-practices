...
import com.example.snapshots.databinding.ItemSnapshotsBinding
...
class HomeFragment : Fragment(), HomeAux {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        mFirebaseAdapter = object :FirebaseRecyclerAdapter<Snapshot, SnapshotHolder>(options){
            ...
            override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SnapshotHolder {
                ...
                val view = LayoutInflater.from(mContext).inflate(R.layout.item_snapshots, parent,false)
            ...
            override fun onBindViewHolder(holder: SnapshotHolder, position: Int, model: Snapshot) {
                ...
                with(holder){
                    ...
                    //Con esta linea ya registra los likes
                    binding.cbLike.text = snapshot.likeList.keys.size.toString()

                    //Para que nos demos cuenta que el like lo dimos nosotros
    ...
    // Metodo que proporciona la funcionalidad de volver arriba
